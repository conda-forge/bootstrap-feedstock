...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=3743&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/bootstrap-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Installing `bootstrap` from the `conda-forge` channel can be achieved by adding `conda-forge` to your channels with:

```
conda config --add channels conda-forge
```

Once the `conda-forge` channel has been enabled, `bootstrap` can be installed with:

```
conda install bootstrap
```

It is possible to list all of the versions of `bootstrap` available on your platform with:

```
conda search bootstrap --channel conda-forge
```
...
Updating bootstrap-feedstock
============================

If you would like to improve the bootstrap recipe or build a new
...
Note that all branches in the conda-forge/bootstrap-feedstock are
